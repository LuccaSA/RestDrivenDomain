...
namespace RDD.Web.Tests
{
    public class ExchangeRateIntegrationTest
    {
        ...
        {
            ExchangeRateController.ConfigurableAllowedHttpVerbs = Domain.Helpers.HttpVerb.Get;
            var response = await _client.GetAsync("/ExchangeRate/");
            Assert.Equal(HttpStatusCode.OK, response.StatusCode);

            ExchangeRateController.ConfigurableAllowedHttpVerbs = Domain.Helpers.HttpVerb.None;
        ...
        public async Task PutOkAsync()
        {
            ...
            ExchangeRateController.ConfigurableAllowedHttpVerbs = Domain.Helpers.HttpVerb.Put;
        ...
        public async Task PostOkAsync()
        {
            ...
            ExchangeRateController.ConfigurableAllowedHttpVerbs = Domain.Helpers.HttpVerb.Post;
        ...
        public async Task DeleteOkAsync()
        {
            ...
            ExchangeRateController.ConfigurableAllowedHttpVerbs = Domain.Helpers.HttpVerb.Delete;
