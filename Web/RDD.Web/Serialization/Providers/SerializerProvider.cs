...
namespace RDD.Web.Serialization.Providers
{
    public class SerializerProvider : ISerializerProvider
	{
        ...
        public object Serialize(object entity, SerializationOption options)
        {
            return ToJson(entity, options).GetContent();
        }

        public IJsonElement ToJson(object entity, SerializationOption options)
        {
            return GetSerializer(entity).ToJson(entity, options);
        }
