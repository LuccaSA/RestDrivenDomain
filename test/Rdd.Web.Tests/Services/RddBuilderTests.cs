...
namespace Rdd.Web.Tests.Services
{
    public class RddBuilderTests
    {
        ...
        class CollectionPipo : IRestCollection<Hierarchy, int>
        {
            ...
            public Task<Hierarchy> UpdateByIdAsync(int id, ICandidate<Hierarchy, int> candidate, Query<Hierarchy> query = null, CancellationToken cancellationToken = default) => throw new NotImplementedException();
            public Task<IEnumerable<Hierarchy>> UpdateByIdsAsync(IDictionary<int, ICandidate<Hierarchy, int>> candidatesByIds, Query<Hierarchy> query = null, CancellationToken cancellationToken = default) => throw new NotImplementedException();
        }
